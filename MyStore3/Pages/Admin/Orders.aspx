<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Orders.aspx.cs" Inherits="MyStore3.Pages.Admin.Orders" MasterPageFile="~/Pages/Admin/Admin.Master" %>
    ...
    <div class="outerContainer">
        <table id="ordersTable">
            ...
            <asp:Repeater ID="Repeater1" runat="server" SelectMethod="GetOrders"
                ItemType="MyStore3.Models.Order">
                <ItemTemplate>
                    <tr>
                        <td><%#: Item.Name %></td>
                        <td><%#: Item.City %></td>
